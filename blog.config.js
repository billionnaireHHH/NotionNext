...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'billionaireHHH', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的煮饭人❤', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eosin-ten.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,小助理', // 网站关键词 英文逗号隔开
